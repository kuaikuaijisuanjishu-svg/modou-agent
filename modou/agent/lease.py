...
# Hard ceiling on any single lease.  This is a safety property, not a tuning
# knob: no caller (standing authorizations included) may talk a lease into
# outliving it, which is why unattended budgets must stay within
# ceiling - overhead seconds.
LEASE_TTL_CEILING_SECONDS = 7200.0
...
class RepositoryLeaseManager:
    ...
    def acquire(self, *, repo_fingerprint: str, review_id: str, operation: str,
        ...
        ttl = max(5.0, min(float(ttl_seconds), LEASE_TTL_CEILING_SECONDS))
